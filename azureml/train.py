...
if __name__ == "__main__":
    ...
    fig1.write_html(f"{PDF_VISUAL_PATH}topics_visualization.html")
    
    fig2 = topic_model.visualize_barchart()
    fig2.write_html(f"{PDF_VISUAL_PATH}topics_barcharts.html")
    
    fig3 = topic_model.visualize_hierarchy(hierarchical_topics=hierarchical_topics)
    fig3.write_html(f"{PDF_VISUAL_PATH}topics_hierarchy.html")
    
    fig5 = topic_model.visualize_documents(df_final['clean_text'])
    fig5.write_html(f"{PDF_VISUAL_PATH}topics_barcharts.html")
    
    fig6 = topic_model.visualize_distribution(probabilities[5])
    fig6.write_html(f"{PDF_VISUAL_PATH}topics_prob_dist.html")
